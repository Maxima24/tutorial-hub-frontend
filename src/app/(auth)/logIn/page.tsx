       ...
       <div className="w-full lg:w-2/5 xl:w-2/3 flex items-center justify-center p-6 lg:p-8">
        <div className="w-full md:max-w-[410px] max-w-[400px] mx-auto">
          ...
          <div className="mb-10">
            ...
            <p className="text-gray-600">Sign in to continue with Tutorial Hub</p>
          </div>
          ...
          <form onSubmit={handleSubmit}  className="space-y-6 mb-8" autoComplete="off">
            ...
            <div className="flex justify-between space-x-2 text-sm">
              <div className="flex items-start space-x-2 text-sm">
                <input type="checkbox" className="w-4 h-4 mt-0.5 accent-blue-600 border-gray-300 rounded focus:ring-primary"  />
                <span className="text-gray-600">
                  Remember me
                </span>  
              </div>
              <Link href="/forgot-password">
              <p className="cursor-pointer hover:text-gray-400">Forgot password?</p>
              </Link>
