...
function Page() {
  ...
  return (
      ...
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-2">Upload New Tutorial</h1>
            ...
            {[
              ...
              <div key={idx} className="flex items-center flex-1">
                <div className="flex flex-col items-center flex-1">
                  ...
                  <div className="text-sm font-medium mt-2 text-gray-700">{step.label}</div>
                </div>
                {idx < 3 && (
                  <div
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="flex gap-4 pt-8">
              ...
              <button
                ...
                className="flex-1 px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-xl font-medium hover:shadow-lg transition-all flex items-center justify-center gap-2"
              >
