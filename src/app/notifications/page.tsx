          ...
          <div className="p-4 sm:p-6 md:p-8 w-full ">
            ...
            <div className="flex gap-3 mb-4 overflow-x-auto scrollbar-hide pb-2">
              {['All', 'Unread', 'Courses', 'Messages', 'System'].map((filter, idx) => (
                <button
                  ...
                  className={`flex-shrink-0 px-4 py-2 rounded-lg font-medium text-sm sm:text-base transition-all  ${
                    sortOrder === filter
            ...
            <div className="space-y-4 py-4 rounded-md bg-white ">
              {filteredNotifications.map((notif, idx) => (
                <div
                  key={idx}
                  className={`not-first:border-t border-neutral-200 px-8 transition-all cursor-pointer w-full max-w-full ${
                    notif.unread ? '' : ''
                  }`}
                >
                  <div className="flex items-start gap-3 sm:gap-4 mt-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-gray-600 text-sm sm:text-base mb-2">{notif.message}</p>
            ...
            <div className="text-center mt-8">
              <button className="px-6 py-3 border-2 border-gray-200 rounded-xl font-medium hover:border-blue-500 hover:text-blue-500 transition-all text-sm sm:text-base">
